...
var appRoutes = [
    { path: 'results', component: _components_results_results_component__WEBPACK_IMPORTED_MODULE_15__["ResultsComponent"] },
...
module.exports = "#test{\r\n    margin:0;\r\n    padding: 0; \r\n    height: 100%;\r\n}\r\n.zero{\r\n    height: 100vh;\r\n}\r\n#titleText{\r\n    font-family: Pacifico;\r\n    font-weight: 100;\r\n    font-size: 4em;\r\n    color: rgb(255, 255, 255);\r\n    text-shadow: rgb(158, 94, 41) -5px 5px 1px;\r\n    margin-top: 25%;\r\n    background-clip: text;\r\n}\r\nh1::after{\r\n    background-image: linear-gradient(-20deg, #fc6076 0%, #ff9a44 100%);\r\n    mix-blend-mode: screen;\r\n\r\n}\r\n#inputFields{\r\n    margin-top: 15%;\r\n    padding: 20px;\r\n\r\n}\r\n#zipCode{\r\n    width: 30%;\r\n\r\n}"
...
module.exports = "<!--The content below is only a placeholder and can be replaced.-->\n<ngx-spinner\n  bdColor=\"rgba(51,51,51,0.8)\"\n  size=\"medium\"\n  color=\"#fff\"\n  type=\"pacman\">\n <p style=\"font-size: 20px; color: white; \">Loading...</p>\n</ngx-spinner>\n<div fxLayout='row' fxLayoutAlign=\"center center\" class=\"zero\">\n  <div fxFlex=\"50\" fxFlex.md=\"75\" fxFlex.sm=\"100\" fxFlexFill fxFlexAlign=\"center\" id=\"test\">\n    <div fxLayoutAlign=\"center\" id=\"title\">\n      <h1 id=\"titleText\">Not Sure What To Eat Today?</h1>\n    </div>\n    <div fxLayout='row wrap' fxLayoutAlign=\"start\" fxLayoutGap=\"20px\" id=\"inputFields\">\n      <mat-form-field fxFlex=\"80\" id=\"zipCode\">\n        <input matInput placeholder=\"Zip Code or Address\">\n      </mat-form-field>\n      <mat-select fxFlex=\"15\" placeholder=\"Range in Miles\">\n        <mat-option *ngFor=\"let range of ranges\" [value]=\"range.value\">\n          {{range.viewValue}}\n        </mat-option>\n      </mat-select>\n      <mat-select fxFlex=\"25\" placeholder=\"Place Type\">\n        <mat-option *ngFor=\"let type of types\" [value]=\"type.value\">\n          {{type.viewValue}}\n        </mat-option>\n      </mat-select>\n      <mat-slider fxFlex=\"10\" thumbLabel [displayWith]=\"formatLabel\" tickInterval=\"1\" min=\"0\" max=\"4\"></mat-slider>\n      <div fxLayout='row wrap' fxFlex=\"100\" fxLayoutAlign=\"end\" >\n        <button mat-button type=\"button\" fxFlex=\"15\" (click)=\"submitt()\">Submit</button>\n      </div>\n    </div>\n  </div>\n</div>"
...
var HomeComponent = /** @class */ (function () {
    function HomeComponent(router, spinner) {
        this.router = router;
        this.spinner = spinner;
        this.types = [
            { value: 'restaurant-0', viewValue: 'Restaurant' },
            { value: 'bar-1', viewValue: 'Bar' },
            { value: 'fastfood-2', viewValue: 'Fast Food' }
        ];
        this.ranges = [
    ...
    HomeComponent.prototype.submitt = function () {
        var _this = this;
        this.spinner.show();
        setTimeout(function () {
            _this.spinner.hide();
    ...
    HomeComponent.prototype.if = function (f) {
        console.log(f);
    };
    HomeComponent.prototype.formatLabel = function (value) {
        if (!value) {
            return "$";
        }
    ...
    __decorate([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_0__["Input"])('mat-select-trigger'),
    ...
    HomeComponent = __decorate([
        ...
        __metadata("design:paramtypes", [_angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"], ngx_spinner__WEBPACK_IMPORTED_MODULE_1__["NgxSpinnerService"]])
    ], HomeComponent);
...
module.exports = "<div fxLayout=\"row\"  fxLayoutAlignment=\"start\" id=\"results\">\n  <div fxFlex=\"20\" fxFill id=\"left\">\n    <div fxLayout=\"column\" fxFill fxLayoutAlignment=\"start start\">\n      <div fxFlex=\"10\"><h1>Results for </h1></div>\n      <div fxFlex=\"20\" id=\"item\">sd</div>\n      <div fxFlex=\"20\" id=\"item\">sd</div>\n      <div fxFlex=\"20\" id=\"item\">sd</div>\n      <div fxFlex=\"20\" id=\"item\">sd</div>\n      <div fxFlex=\"20\" id=\"item\">sd</div>\n\n    </div>\n\n  </div>\n  <div fxFlex=\"0.1\" fxFill id=\"divider\"></div>\n  <div fxFlex=\"80\" fxFill id=\"right\">\n    <agm-map  [latitude]=\"latitude\" [longitude]=\"longitude\" [zoom]=15 [styles]=\"styles\"  style=\"height:100%;\"></agm-map>\n  </div>\n</div>\n"
...
var ResultsComponent = /** @class */ (function () {
    function ResultsComponent() {
        this.latitude = 41.524606;
        this.longitude = -72.777693;
        this.styles = [
            {
                "elementType": "labels",
                "stylers": [
...
module.exports = __webpack_require__(/*! E:\Websites\WDYWTE_Angular\FoodApp\src\main.ts */"./src/main.ts");
